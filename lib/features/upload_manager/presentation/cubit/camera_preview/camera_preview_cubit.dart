...
class CameraPreviewCubit extends Cubit<CameraPreviewState> {
  ...
  Future<void> initialize() async {
    ...
    result.fold(
      (_) => emit(state.copyWith(message: 'Failed to initialize camera')),
  ...
  Future<void> toggleCamera() async {
    ...
    result.fold(
      (_) => emit(state.copyWith(message: 'Camera switch failed')),
      (cameraLens) => emit(state.copyWith(cameraLens: cameraLens)),
    );
  }
}
